  ...
  stdenv.mkDerivation rec {
    ...
    postFixup = ''
      wrapProgram $out/bin/claude \
        ...
        --set BASH_DEFAULT_TIMEOUT_MS 300000 \
        --set BASH_MAX_TIMEOUT_MS 1200000 \
        --set CLAUDE_CODE_DISABLE_AUTO_MEMORY 1 \
        --set CLAUDE_CODE_DISABLE_FEEDBACK_SURVEY 1 \
        --set CLAUDE_CODE_DISABLE_GIT_INSTRUCTIONS 1 \
        --set CLAUDE_CODE_DISABLE_OFFICIAL_MARKETPLACE_AUTOINSTALL 1 \
        --set CLAUDE_CODE_DISABLE_TERMINAL_TITLE 1 \
        --set CLAUDE_CODE_SIMPLE_SYSTEM_PROMPT 1 \
